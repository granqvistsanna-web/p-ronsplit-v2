  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="container max-w-3xl mx-auto px-6 pt-24 pb-20 md:pt-32 md:pb-28">
        <div className="space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">Håll koll på gemensamma inkomster och utgifter med familjen, kompisarna eller sambon. Sätt sparmål och mer.</p>
          <div className="pt-4">
